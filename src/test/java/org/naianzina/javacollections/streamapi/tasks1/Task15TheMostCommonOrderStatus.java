...
public class Task15TheMostCommonOrderStatus {

    public static void main(String [] args) {

        // Task15: Find the most common order status
        ...
        System.out.println("--- The most common order status ---");

        String mostCommonStatus = listOfPersons
                .stream()
        ...
        System.out.println(mostCommonStatus);
